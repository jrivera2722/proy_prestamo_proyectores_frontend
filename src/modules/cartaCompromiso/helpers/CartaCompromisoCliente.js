...
const guardarCartaCompromiso = async (bodyCartaCompromiso) => {
    const data = axios.post(`http://10.3.2.44:8082/API/v1.0/Prestamos/cartasCompromiso`, bodyCartaCompromiso).then(r => r.data);
    return data;
}

const buscarPorIdCartaCompromiso = async (id) => {
    const data = axios.get(`http://10.3.2.44:8082/API/v1.0/Prestamos/cartasCompromiso/${id}`).then(r => r.data);
    return data;
}

const buscarPorAsignaturaCartaCompromiso = async (asignatura) => {
    const data = axios.get(`http://10.3.2.44:8082/API/v1.0/Prestamos/cartasCompromiso/a?asignatura=${asignatura}`).then(r => r.data);
    return data;
}

const buscarPorParaleloSemestreCartaCompromiso = async (paralelo, semestre) => {
    const data = axios.get(`http://10.3.2.44:8082/API/v1.0/Prestamos/cartasCompromiso/p?paralelo=${paralelo}&semestre=${semestre}`).then(r => r.data);
    return data;
}

const buscarPorDiaCartaCompromiso = async (dia) => {
    const data = axios.get(`http://10.3.2.44:8082/API/v1.0/Prestamos/cartasCompromiso/d?dia=${dia}`).then(r => r.data);
    return data;
}

const buscarTodosCartasCompromiso = async () => {
    const data = axios.get(`http://10.3.2.44:8082/API/v1.0/Prestamos/cartasCompromiso`).then(r => r.data);
    return data;
}

const actualizarCartaCompromiso = async (bodyCartaCompromiso, id) => {
    const data = await axios.put(`http://10.3.2.44:8082/API/v1.0/Prestamos/cartasCompromiso/${id}`, bodyCartaCompromiso).then(r => r.data);
    return data;
}