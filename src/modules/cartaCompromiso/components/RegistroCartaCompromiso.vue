            ...
            <div class="formulario">
                ...
                <ul>
                    <li v-for="(item, index) in dias" :key="index">
                        <h4 style="color: black; font-family: Georgia, 'Times New Roman', Times, serif; font-size: 40px;">Horario {{ index + 1 }}</h4>
                        <div class="form-floating">
                        ...
                        <div class="form-floating">
                            <input id="horInput" type="time" v-model="item.horaPrestamo" class="form-control"
                                placeholder="00:00">
                            <label style="color: #462255;" for="horInput">Hora del préstamo</label>
                        </div>
                        <div class="form-floating">
                            ...
                            <label style="color: #462255;" for="diaDevInput">Día Devolución</label>
                        </div>
                        <div class="form-floating">
                            <input id="horDevInput" type="time" v-model="item.horaDevolucion" class="form-control"
                                placeholder="Química I">
                            <label style="color: #462255;" for="horDevInput">Hora de la devolución</label>
                        </div>
                    </li>
                </ul>
                ...
                <div>
                    <button class="btn btn-outline-secondary" @click="registrarCartaCompromiso"
                        style="margin-bottom: 1%; color: black;">Guardar</button>
                </div>
                <div>
